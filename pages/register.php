...
if(isset($_POST['register'])){
    ...
    // menyiapkan query
    $sql = "INSERT INTO admin (nip, nama, email, password, role, nomor_telp , jk ) 
            VALUES (:nip, :nama, :email, :password, :role, :nomor_telp, :jk)";
                ...
                <p>&larr; <a href="../index.php">Home</a>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nip" placeholder="NIP kamu" />
                        </div>
